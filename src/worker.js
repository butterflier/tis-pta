...
const AUTO_RECIPIENTS = {
  dragon: ["임승민"],
  tiger: [],
  freedom_sprit: ["김하은", "이윤아", "윤준휘", "김우찬", "은성준", "신석현", "홍준서", "이예지", "현은지", "하성문", "정한", "정서윤", "김민성", "김지호", "김건", "신재민", "황현수"],
  homework_anhae: ["김하은", "이윤아", "이준원", "윤준휘", "김우찬", "윤주원", "은성준", "신석현", "홍준서", "전미경", "이예지", "김성은", "현은지", "하성문", "정한", "정서윤", "김민성", "곽진우", "김지호", "배세진", "김건", "신재민", "황현수"],
  nanguk: ["이윤아", "김우찬", "은성준", "홍준서", "하성문", "정한", "정서윤"],
};
