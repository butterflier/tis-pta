...
const AUTO_RECIPIENTS = {
  dragon: ["임승민", "이준원", "전미경", "김성은", "문서진", "이서현"],
  tiger: ["문서진"],
  freedom_sprit: ["이윤아", "윤준휘", "김우찬", "은성준", "홍준서", "현은지", "하성문", "정한", "정서윤", "김지호", "신재민", "황현수"],
  homework_anhae: ["김하은", "이윤아", "임승민", "이준원", "윤준휘", "김우찬", "윤주원", "은성준", "신석현", "홍준서", "이예지", "현은지", "하성문", "정한", "정서윤", "김민성", "곽진우", "김지호", "배세진", "김건", "신재민", "황현수"],
  nanguk: ["김우찬", "은성준", "정한", "정서윤"],
};
